...
class RefundLedgerStatus(StrEnum):
    RESERVED = "reserved"
...
class PaymentIntegrityCode(StrEnum):
    ...
    REFUND_BALANCE_EXHAUSTED = "REFUND_BALANCE_EXHAUSTED"
    REFUND_BALANCE_UNAVAILABLE = "REFUND_BALANCE_UNAVAILABLE"
    DUPLICATE_REQUEST = "DUPLICATE_REQUEST"
    CONCURRENT_BALANCE_CONFLICT = "CONCURRENT_BALANCE_CONFLICT"
